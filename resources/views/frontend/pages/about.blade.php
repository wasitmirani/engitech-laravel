...
{{-- Logo Component --}}
@component('frontend.components.logoComponent')
@endcomponent
{{-- Logo Component --}}
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <a class="ot-image-box v3 st1" href="it-services.html">
                            ...
                            <img src="assets/images/image-box1.jpg" alt="Our Mission">
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <a class="ot-image-box v3 st2" href="it-services.html">
                            ...
                            <img src="assets/images/image-box2.jpg" alt="Our Vision">
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <a class="ot-image-box v3 st3" href="it-services.html">
                            ...
                            <img src="assets/images/image-box3.jpg" alt="Our Philosophy">
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <a class="ot-image-box v3 st4 mb-0" href="it-services.html">
                            ...
                            <img src="assets/images/image-box4.jpg" alt="Our Strategy">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 align-self-center">
                <div class="pabout-left">
                    <img src="assets/images/image1-about.png" alt="">
                </div>
            </div>
            <div class="col-lg-6">
...
<section class="about-counter">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img src="assets/images/image2-about.png" alt="">
            </div>
        </div>
    </div>
</section>
